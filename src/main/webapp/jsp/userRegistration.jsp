...
<% if(model != null) { %>
<% if(model.isSuccess()) { %>
<div><p class = "text-success">Registration is successful! You can <a href="userLogin">log in!</a></p></div>
<% } else { %>
...
<div class="container">
<form class="form-horizontal" name="registrationForm" method="post" action="userRegistration">
<fieldset>
